...
public class SortStep{
  ...
  public void sortMenu(){
    ...
    do{
      ...
      System.out.println();
      System.out.println("(1) Bubble sort (not on exam)");
      ...
      if ('1' <= choice.charAt(0) && choice.charAt(0) <= '6'){
        ...
        switch (choice.charAt(0)){
            case '1':
              resetArray();
              mySorts.setStepCount(mySorts.bubbleSort(myArray));
              break;
            case '2':
              resetArray();
              mySorts.setStepCount(mySorts.selectionSort(myArray));
              break;
            case '3':
              resetArray();
              mySorts.setStepCount(mySorts.insertionSort(myArray));
              break;
            case '4':
              resetArray();
              mySorts.setStepCount(mySorts.mergeSort(myArray));
              break;
            case '5':
           listType = "Integer";
              break;
